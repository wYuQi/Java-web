...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form action="ShipmentGet.do" method="post">			
			<table class="maintable">
					...
					<td>
						...
						<%for(Map<String,String> marketList : list){ %>
							<option value="<%=marketList.get("id")%>"><%=marketList.get("goodsName") %></option>
						<%} %>
						</select>
					</td>
					</tr>
				<tr>
					...
					<td>
						<input class="text" name="account"/><p style= "color:red"><%=session.getAttribute("less")==null? "": session.getAttribute("less")%></p>
